...
public abstract class Vehicles implements IMovable {
    ...
    //Constructor
    public Vehicles(int nrDoors, double enginePower, double currentSpeed, directions currentDirection, String modelName, Color color, double x, double y, double widthCars, double lengthCars) {
